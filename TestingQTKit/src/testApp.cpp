...
//    vidGrabber.setVideoDeviceID("Logitech Camera #2");
...
//	vidGrabber.listAudioCodecs();
	...
	//vidGrabber.setVideoCodec("QTCompressionOptionsHD720SizeH264Video");
    //vidGrabber.setVideoCodec("QTCompressionOptionsSD480SizeH264Video");
    ...
    //no audio, max performance, audio is useful for now...
...
void testApp::draw(){
    ...
    ofDrawBitmapString(s.str(), 20, ofGetHeight() - 80);
}
